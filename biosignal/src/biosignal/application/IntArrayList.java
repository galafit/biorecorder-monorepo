...
//    public biosignal.application.IntArrayList(int[] source) {
//        size = source.length;
//        com.biorecorder.data = new int[size];
//        System.arraycopy(source, 0, com.biorecorder.data, 0, size);
//    }
...
//        rangeCheck(index);
//        return com.biorecorder.data[index];
//    }
...
//        rangeCheck(index);
//        com.biorecorder.data[index] = value;
//    }
...
//        if (com.biorecorder.data.length > size) {
//            int[] tmp = new int[size];
//            System.arraycopy(com.biorecorder.data, 0, tmp, 0, size);
//            com.biorecorder.data = tmp;
//        }
//    }
