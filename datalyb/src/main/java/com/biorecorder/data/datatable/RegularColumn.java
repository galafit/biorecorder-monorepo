...
public class RegularColumn extends DoubleColumn {
    ...
    public void append(Column col) throws IllegalArgumentException {
        if(col instanceof RegularColumn) {
            ...
            if(rc.step == step) {
                ...
                data = new BaseDoubleEditableSequence(regularSequence(startValue, step, size1));
            } else {
    ...
    private static DoubleSequence regularSequence(double startValue, double step, int size) {
